    ...
    def train(self):
        ...
        for epoch in range(start_epoch, self.max_epoch):
            ...
            for step, data in enumerate(self.data_loader, 0):
                ...
                text_add_noise = Variable(torch.FloatTensor(batch_size, cfg.TEXT.EMBEDDING_DIM).normal_(0, 1)).cuda()
                words_embs += text_add_noise.repeat(words_embs.shape[-1],1,1).permute(1,2,0)
                sent_emb += text_add_noise
