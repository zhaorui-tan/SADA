...
class G_DCGAN(nn.Module):
    ...
    def forward(self, z_code, cn, sent_emb, word_embs, mask):
        """
            :param z_code: batch x cfg.GAN.Z_DIM
            :param sent_emb: batch x cfg.TEXT.EMBEDDING_DIM
            :param word_embs: batch x cdf x seq_len
...
class D_NET64(nn.Module):
    def __init__(self, b_jcu=True):
        ...
        ndf = cfg.GAN.DF_DIM
        nef = cfg.TEXT.EMBEDDING_DIM + cfg.GAN.Z_DIM
...
#         with torch.no_grad():
#             aug = torch.mul(x, self.C1) + y.cuda()
#             # if use_r:
#             # aug2 = torch.mul(n2, self.C2)
#             # print('x',x)
#         return aug.float()
#
